...
class TransferTokensAction private constructor(
    ...
    companion object {
        ...
        fun create(
            ...
            to: RadixAddress?,
            amount: BigDecimal,
            tokenClass: TokenRef): TransferTokensAction {
            return TransferTokensAction(from, to, amount, tokenClass, null, emptyMap())
        }
        ...
        fun create(
            ...
            return TransferTokensAction(from, to, amount, tokenReference, attachment, emptyMap())
        }
        ...
        fun create(
            ...
            return TransferTokensAction(from, to, amount, tokenReference, null, metaData)
        }
        ...
        fun create(
            ...
            return TransferTokensAction(from, to, amount, tokenReference, attachment, metaData)
        }
    }
}
